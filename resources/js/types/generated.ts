...
export type DatabaseOptionData = {
    value: number;
    label: string;
...
export type PhpVersionOptionData = {
    value: string;
    label: string;
    isDefault: boolean;
};
...
export type ProvisionScriptData = {
    id: number;
    serverId: number;
...
export type ServerSiteCreationData = {
    id: number;
    slug: string;
    name: string;
    phpVersions: { [key: number]: PhpVersionOptionData };
    unixUsers: { [key: number]: SelectOptionData };
    databases: { [key: number]: DatabaseOptionData };
    databaseUsers: { [key: number]: SelectOptionData };
};
