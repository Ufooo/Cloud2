...
bannedSinceHuman: string;
remainingTimeHuman: string;
isPermanent: boolean;
country: string | null;
countryCode: string | null;
attackRequests: { [key: number]: string };
...
export enum CertificateStatus { Pending = 'pending', PendingVerification = 'pending_verification', Installing = 'installing', Installed = 'installed', Renewing = 'renewing', Removing = 'removing', Failed = 'failed' };
export enum CertificateType { LetsEncrypt = 'letsencrypt', Existing = 'existing', Csr = 'csr', Clone = 'clone' };
export enum ComposerCredentialStatus { Pending = 'pending', Syncing = 'syncing', Synced = 'synced', Deleting = 'deleting', Failed = 'failed' };
...
export enum DatabaseStatus { Pending = 'pending', Installing = 'installing', Installed = 'installed', Deleting = 'deleting', Failed = 'failed' };
export enum DatabaseType { Mysql80 = 'mysql80', Mysql84 = 'mysql84', Mariadb1011 = 'mariadb1011', Mariadb114 = 'mariadb114', Postgresql16 = 'postgresql16', Postgresql17 = 'postgresql17', Postgresql18 = 'postgresql18', Mysql = 'mysql', Mariadb = 'mariadb', Postgresql = 'postgresql' };
...
export enum ProcessStatus { Pending = 'pending', Installing = 'installing', Installed = 'installed', Deleting = 'deleting', Failed = 'failed' };
...
export enum ProvisionScriptStatus { Pending = 'pending', Executing = 'executing', Completed = 'completed', Failed = 'failed' };
...
export enum RedirectRuleStatus { Pending = 'pending', Installing = 'installing', Installed = 'installed', Updating = 'updating', Removing = 'removing', Failed = 'failed' };
...
envClearConfigCache: boolean;
envRestartQueue: boolean;
...
export enum SiteProvisioningStep { Initializing = 0, CreatingSiteConfigDirectory = 1, CreatingNginxServerBlock = 2, ConfiguringWwwRedirect = 3, EnablingNginxSite = 4, CreatingPhpFpmPool = 5, RestartingServices = 6, CreatingLogrotateConfig = 7, InstallingWpCli = 8, CreatingSiteDirectory = 10, CloningRepository = 11, ConfiguringEnvironment = 12, InstallingComposerDependencies = 13, BuildingFrontendAssets = 14, RunningMigrations = 15, InstallingApplication = 16, FinalizingSite = 99 };
...
export enum SshKeyStatus { Pending = 'pending', Installed = 'installed', Failed = 'failed', Deleting = 'deleting' };
export enum SslStatus { Active = 'active', Expiring = 'expiring', Expired = 'expired', None = 'none' };
...
export enum UbuntuVersion { V2404 = '24.04', V2204 = '22.04', V2004 = '20.04', Fedora43 = 'fedora43' };
...
export enum UserStatus { Pending = 'pending', Installing = 'installing', Installed = 'installed', Deleting = 'deleting', Failed = 'failed' };
export enum WildcardBehavior { Serve = 'serve', Redirect = 'redirect' };
export enum WwwRedirectType { FromWww = 'from_www', ToWww = 'to_www', None = 'none', ToPrimary = 'to_primary' };
