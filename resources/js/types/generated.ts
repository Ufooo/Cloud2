...
export enum SiteProvisioningStep { Initializing = 0, ConfiguringNginx = 1, CloningRepository = 2, CreatingEnvironmentFile = 3, InstallingDependencies = 4, BuildingFrontendAssets = 5, RunningMigrations = 6, FinishingUp = 99 };
