...
const versionColors: Record<string, string> = {
    ...
    '8.0': 'bg-amber-50 text-amber-600 border-amber-200 dark:bg-amber-950 dark:text-amber-400 dark:border-amber-800',
...
export function usePhpVersionBadge(
    ...
    return computed(() => {
        ...
        const colorClass = versionColors[currentVersion] ?? '';
