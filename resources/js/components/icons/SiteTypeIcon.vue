...
import LaravelIcon from './LaravelIcon.vue';
import NextJsIcon from './NextJsIcon.vue';
import NuxtJsIcon from './NuxtJsIcon.vue';
...
<template>
    <LaravelIcon v-if="type === 'laravel'" />
    <SymfonyIcon v-else-if="type === 'symfony'" />
